...
import restaurante.excepciones.EdadException;
import restaurante.excepciones.NombreException;
import restaurante.excepciones.NumeroMeseroException;
import restaurante.excepciones.PasswordException;
import restaurante.excepciones.SexoException;
import restaurante.excepciones.TelefonoException;
import restaurante.excepciones.UserNameException;

/**
 * Metodos es una clase que contiene métodos estáticos, los cuales son las funciones que se pueden realizar para la administración del Restaurante.
 * @author Equipo 10 POO
 */
public class Metodos {

/**
 * Crea un Mesero y le asigna los valores dados por el usuario a sus atributos.
 * @return Devuelve un objeto de la clase de Mesero.
 */
...
/**
 * Crea un Administrador y le asigna los valores dados por el usuario a sus atributos.
 * @return Devuelve un objeto de la clase de Administrador.
 */
...
/**
 * Le pide al Mesero su nombre de usuario y su contraseña. Para posteriormente verificar si está registrado. 
 * @param arrMeseros ArrayList que contiene a los meseros registrados.
 * @return Devuelve un true si el nombre de usuario y la contraseña fueron encontrados y son correctos. De lo contrario devuelve false.
 */
...
/**
 * Le pide al Administrador su nombre de usuario y su contraseña. Para posteriormente verificar si está registrado. 
...
/**
 * Imprime la información de todos los meseros registrados.
 * @param arrMeseros ArrayList que contiene a los meseros registrados.
 */
...
/**
 * Imprime las ventas generadas por cada mesero.
 * @param arrMeseros ArrayList que contiene a los meseros registrados.
 */
...
/**
 * Imprime las ventas generadas por cada mesa.
...
/**
 * Imprime la información de todos los administradores registrados.
 * @param arrAdmin ArrayList que contiene a los administradores registrados.
 */
...
/**
 * Imprime la información de las mesas disponibles.
...
/**
 * Imprime la información de las mesas ocupadas.
 * @param ocupadas Set que contiene todas las mesas ocupadas del restaurante. 
 */
...
/**
 * Imprime la información de todas las mesas del restaurante.
 * @param arrMesas ArrayList que contiene todas las mesas del restaurante. 
 */
...
/**
 * Imprime la información de los meseros disponibles.
...
/**
 * Crea una orden. Asocia una Mesa con un Mesero y una Orden.
 * @param arrMesas ArrayList que contiene todas las mesas del restaurante.
...
/**
 * Libera una Mesa. Cambia los atributos de un objeto Mesa y Mesero para que ahora estén disponibles.
 * @param arrMesas ArrayList que contiene todas las mesas del restaurante.
 * @param mesasR Set que contiene todas las mesas del restaurante.
 * @param ocupadas Set que contiene todas las mesas ocupadas del restaurante.
 * @param MeserosO ArrayList que contiene todas los meseros ocupados del restaurante.  
...
/**
 * Modifica algún atributo de un objeto Mesero, dependiendo que quiera cambiar el usuario. 
 * @param arrMeseros ArrayList que contiene todas los meseros del restaurante.
 */
...
/**
 * Muestra las estadísticas del Restaurante: los porcentajes de las ventas de cada Platillo y el Mesero que ha vendido más platillos.
